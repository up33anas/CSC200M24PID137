import Game from "../viewModels/GameEngine.js";
import { isSameColor, canPlaceOnDestination } from "../utils/gameRules.js";
...
// console.assert(isSameColor("Hearts", "Diamonds") === true);
// console.assert(isSameColor("Clubs", "Spades") === true);
// console.assert(isSameColor("Hearts", "Clubs") === false);
